            ...
            <div class="row">
                <div class="col col-4">
                    <div class="w-100 border rounded-3 shadow-sm mt-3">
                        <h3 class="fs-2 mt-4 mb-2 text-center">Register</h3>
                        <p class="text-center text-secondary mb-5">Register An Account</p>
                        <div class="mb-3 mx-4">
                        ...
                        <div class="d-grid gap-2 mx-4 mt-4 mb-5">
                            <button class="btn btn-primary shadow-sm" type="button">Register</button>
                        </div>
